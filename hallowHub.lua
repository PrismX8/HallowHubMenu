--[[
    ...
    Usage:
    local HallowHub = loadstring(game:HttpGet("URL_TO_SCRIPT"))()
    local window = HallowHub.NewWindow("My Cool UI")
    ...
    window:SetLoadingScreenEnabled(true) -- Optional loading screen
--]]
